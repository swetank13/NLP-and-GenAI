...
#from mlflow.protos.scalapb.scalapb_pb2 import message
import os
...
#     sender_pwd = os.getenv("CB_EMAIL_PWD")
#     if not sender_email or not sender_pwd:
#         raise ValueError("Environment variables CB_EMAIL and CB_EMAIL_PWD must be set")
#
#     return Message(
#         mail_from=("Your Name", sender_email),
#         smtp={
#             'host': 'smtp.gmail.com',
#             'port': 587,
#             'user': sender_email,
...
# mcp has tool, prompt, knowledge or resources
...
@mcp.tool()
def send_email(to_emails: List[str], subject: str, body: str, html: bool = False):
